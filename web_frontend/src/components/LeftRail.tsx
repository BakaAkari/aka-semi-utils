  ...
  const onReset = useCallback(() => {
    setConfig({
      ...
      signature: {
        ...
        enhancement: 'none', enhancement_strength: 50,
        anchor: 'middle_center', margin_x: 0, margin_y: 0, size_ratio: 0.20,
      },
      advanced: {
        footer_height_px: 120, logo_height_px: 0, corner_text_ratio: 0,
        global_font: 'NotoSansCJKsc-Bold.otf', global_color: '#222222', margin_color: '#FFFFFF',
        left_margin: 0, right_margin: 0, top_margin: 0, bottom_margin: 0,
        border_radius: 0, shadow_radius: 0, shadow_color: '#000000', blur_radius: 0,
        quality: 95, subsampling: 0, scale: 1,
        trim_enabled: false, trim_threshold: 0, ratio_enabled: false, ratio: '3:4',
        concat_direction: 'vertical', alignment_mode: 'center',
      },
